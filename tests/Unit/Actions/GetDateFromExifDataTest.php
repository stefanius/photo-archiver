...
class GetDateFromExifDataTest extends TestCase
{
    ...
    #[Test]
    public function it_can_get_a_date_from_a_file_with_exif_data()
    {
        // Given
        $today = Carbon::now();
    ...
    #[Test]
    public function it_cannot_get_a_date_from_a_file_without_exif_data()
    {
        // Given
        $filename = 'heic_sample.heic';
        $action = new GetDateFromExifData;
